    ...
    <div className="signin-container">
      ...
      <div className="left-panel">
        <div className="brand-content">
          ...
          <img 
            ...
            className="mascot"
          />
          <h1 className="headline">Join a Community of Change makers.</h1>
          <p className="subtext">
      ...
      <div className="right-panel">
        <div className="form-container">
          <h1 className="form-title">Become a Clinico Volunteer</h1>
          
          {/* Google Sign Up Button */}
          <button className="google-btn">
            <svg className="google-icon" width="18" height="18" viewBox="0 0 18 18" fill="none">
              ...
              <path d="M9 18C11.2 18 13.12 17.2 14.64 15.5789L1.84 13.1579C11 13.6842 10 14.0526 9 14.0526C6.92 14.0526 5.12 12.6842 4.56 10.8421H1.56V13.4211C2.72 15.7368 5.4 17.2632 9 18Z" fill="#34A853"/>
          ...
          <form onSubmit={handleSubmit} className="registration-form">
            <div className="input-group">
              <input
                ...
                required
              />
              <label className="form-label">Username (e.g., Dr. Bhumika Choudhary)</label>
            </div>
            ...
            <button type="submit" className="submit-btn">Apply to Join</button>
          </form>
